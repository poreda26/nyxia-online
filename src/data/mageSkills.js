...
export const MAGE_SKILLS = [
  ...
  { id: "m6", unlockLevel: 25, name: "Kükürt Yağmuru", tier: "advanced", mpCost: 20, cooldown: 3, effect: { type: "dot", mult: 0.75, turns: 3 }, goldCost: 1000, questTier: 2 },
  ...
  { id: "m8", unlockLevel: 35, name: "Ruh Tüketimi", tier: "advanced", mpCost: 24, cooldown: 3, effect: { type: "execute", mult: 2.8, hpPctThreshold: 0.3 }, goldCost: 1400, questTier: 3 },
  ...
  { id: "m10", unlockLevel: 45, name: "Zaman Bükümü", tier: "advanced", mpCost: 26, cooldown: 4, effect: { type: "buffAtk", mult: 1.45, turns: 3 }, goldCost: 1800, questTier: 4 },
  ...
  { id: "m12", unlockLevel: 55, name: "Yaşam Çalma", tier: "advanced", mpCost: 30, cooldown: 5, effect: { type: "heal", pct: 0.25 }, goldCost: 2200, questTier: 4 },
