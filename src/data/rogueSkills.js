...
export const ROGUE_SKILLS = [
  ...
  { id: "r6", unlockLevel: 25, name: "Zehirli Ok", tier: "advanced", mpCost: 20, cooldown: 3, effect: { type: "dot", mult: 0.75, turns: 3 }, goldCost: 1000, questTier: 2 },
  ...
  { id: "r10", unlockLevel: 45, name: "Avcı İçgüdüsü", tier: "advanced", mpCost: 26, cooldown: 4, effect: { type: "buffAtk", mult: 1.45, turns: 3 }, goldCost: 1800, questTier: 4 },
