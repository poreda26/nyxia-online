...
window.scythe=(race='human',plus=7)=>root.render(<div style={{height:620,width:500,background:'#172029'}}><Figure player={{class:'warrior',race,equipped:{mainHand:gmBuildWeaponById('warrior',gmWeaponTemplates('warrior').find(w=>w.name==='Yırtıcı Pençe').id,plus),...Object.fromEntries(['head','chest','legs','gauntlets','boots'].map(slot=>[slot,gmBuildArmor('warrior',slot,4,8)]))}}}/></div>);
